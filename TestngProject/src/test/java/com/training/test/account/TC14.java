...
public class TC14 extends BaseTest {
	...
	public void usermenudropdown6() throws InterruptedException {
		...
		home.clickacctslstactvylnk();
		//create date select
		account.clickacctslstactvySave();
		account.enterintosaveReportTextbox("sample");
		account.entersaveReportUnqtextbox("sampleee");
		//
		account.clickacctslstactvySaveandRun();
