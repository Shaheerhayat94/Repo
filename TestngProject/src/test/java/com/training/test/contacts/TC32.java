...
public class TC32 extends BaseTest {
	...
	public void contacts1 () {
		...
		contacts.clickNewBtn();
		contacts.enterintoNewLastNameTextbox("Indian");
		contacts.enterintoNewAccountNameTextbox("Global Media");
		contacts.clicksSaveAndNewBtn();
		//completion
		}
